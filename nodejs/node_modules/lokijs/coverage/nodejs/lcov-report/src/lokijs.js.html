...
<div class="header medium">
    ...
    <h2>
        ...
        Statements: <span class="metric">68.04% <small>(1022 / 1502)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">58.12% <small>(426 / 733)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">62.61% <small>(144 / 230)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">68.17% <small>(1015 / 1489)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
3708
3709
3710</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function containsCheckFn(a, b) {</span>
...
<span class="cstat-no" title="statement not covered" >        var checkFn;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        checkFn = containsCheckFn(a, b) || <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >          return false;</span>
        };
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.hasOwnProperty('databaseVersion')) {
<span class="cstat-no" title="statement not covered" >        this.databaseVersion = obj.databaseVersion;</span>
      }
&nbsp;
      this.collections = [];
&nbsp;
...
&nbsp;
        ...
        j = 0;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (options &amp;&amp; options.hasOwnProperty(coll.name)) {
&nbsp;
...
&nbsp;
    ...
    Loki.prototype.saveDatabase = function (callback) {
      var cFun = callback || <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >          if (err) {</span>
<span class="cstat-no" title="statement not covered" >            throw err;</span>
          }
<span class="cstat-no" title="statement not covered" >          return;</span>
...
&nbsp;
      // the persistenceAdapter should be present if all is ok, but check to be sure.
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.persistenceAdapter !== null) {
        this.persistenceAdapter.saveDatabase(this.filename, self.serialize(), <span class="fstat-no" title="function not covered" >function saveDatabasecallback() {</span>
...
<span class="cstat-no" title="statement not covered" >          self.constraints.unique[key].remove(doc);</span>
        });
        // now that we can efficiently determine the data[] position of newly added document,
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Apr 09 2015 21:37:11 GMT+0100 (IST)</div>
</div>
